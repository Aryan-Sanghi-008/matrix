      ...
      <div className="qr-history-page">
        <div className="qr-history-error-card">
          ...
          <div className="qr-error-hint">
            If this QR code has expired, please ask staff at the ER desk to
            generate a new one.
          </div>
        </div>
      </div>
    ...
    <div className="qr-history-page">
      <div className="qr-history-container">
        ...
        >
          ...
          <div
            className="qr-history-priority-banner"
        ...
        <section className="qr-history-section qr-identity-section">
          <h1 className="qr-patient-fullname">
          ...
          <div className="qr-identity-grid">
            ...
            <div className="qr-identity-item">
              ...
              <span className="qr-identity-value">
            ...
            <div className="qr-resource-grid">
              <div className="qr-resource-item">
                ...
                <span className="qr-resource-value">
                  {patient.assignedCareZone || "Pending"}
                </span>
              </div>
              <div className="qr-resource-item">
                <span className="qr-resource-label">Room</span>
                <span className="qr-resource-value">
                  {patient.assignedRoom || "Pending"}
                </span>
              </div>
              <div className="qr-resource-item">
                ...
                <span className="qr-resource-value">
                  ...
                  {patient.assignedDoctorSpecialization && (
                    <span className="qr-resource-spec">
                      {" "}
                      ({patient.assignedDoctorSpecialization})
                    </span>
                  )}
              ...
              <div className="qr-resource-item">
                ...
                <span className="qr-resource-value">
                  {patient.assignedSupportStaff || "General"}
                </span>
              </div>
                ...
                <div key={event.id || idx} className="qr-timeline-item">
                        ...
                        background:
                          event.eventType === "PRIORITY_CHANGE"
                            ...
                            : event.eventType === "DISCHARGE"
                              ? "#22c55e"
                              : event.eventType === "INTAKE"
                                ? "#3b82f6"
                                : "#64748b",
                      }}
                    ></div>
                    {idx < patient.timeline.length - 1 && (
                      <div className="qr-timeline-line"></div>
                    )}
                  </div>
                  <div className="qr-timeline-content">
                    <div className="qr-timeline-header">
                      ...
                      <span className="qr-timeline-time">
                        {formatTime(event.timestamp)}
                      </span>
                    </div>
                    <div className="qr-timeline-description">
                      {event.description}
                    </div>
                    {event.performedBy && (
                      <div className="qr-timeline-actor">
                      ...
                      event.oldPriority !== event.newPriority && (
                        <div className="qr-timeline-priority-change">
                          <span
                            style={{
                              color:
                                PRIORITY_CONFIG[event.oldPriority]?.color ||
                                "#64748b",
                            }}
                          >
                            {event.oldPriority}
                          ...
                          <span
                            style={{
                              color:
                                PRIORITY_CONFIG[event.newPriority]?.color ||
                                "#64748b",
                            }}
                          >
                            {event.newPriority}
