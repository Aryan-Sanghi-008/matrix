    ...
    const loadNotifications = async () => {
      try {
        ...
        const newCount = events.filter(
          (_, i) => i < events.length - lastSeenRef.current,
        ).length;
  ...
  const HospitalMark = () => (
    ...
    >
      ...
      <rect
        ...
        height="18.8"
        rx="5"
        fill="url(#hospital-mark-grad)"
        opacity="0.32"
      />
      <path
        d="M12 5.8v10.6M6.7 11.1h10.6"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
      />
      <path
        d="M5.2 7.1a7.6 7.6 0 0 0 0 9.8M18.8 7.1a7.6 7.6 0 0 1 0 9.8"
        fill="none"
        stroke="currentColor"
        strokeWidth="1.4"
        strokeLinecap="round"
    ...
    <header className="header-new">
      <div className="header-left">
        <div className="header-logo-badge">
          <img src={logoImg} alt="ER Triage Logo" className="logo-icon" />
        </div>
              ...
              {searching ? (
                ...
                searchResults.map((p) => (
                  <div
                    ...
                    onClick={() => scrollToPatient(p.id)}
                  >
                    <span
                      className="search-result-priority"
                      style={{ color: priorityColors[p.priority] || "#6b7c95" }}
                    >
                      ●
                    </span>
