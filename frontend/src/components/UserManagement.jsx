    ...
    <div className="user-management">
      <div className="user-mgmt-header">
        <div>
          ...
          <div className="user-mgmt-subtitle">
            Manage hospital staff, doctors, nurses, and support personnel
          </div>
        </div>
          ...
          <div className="staff-form-overlay" onClick={closeForm}>
            ...
            >
              <div className="staff-form-header">
                ...
                <button className="staff-form-close" onClick={closeForm}>
                  ✕
                </button>
              </div>
              <form onSubmit={handleSubmit} className="staff-form">
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    placeholder="e.g. amy.jones@hospital.com"
                  />
                </div>
      ...
      {loading ? (
        <div className="users-empty">
          <div className="users-empty-icon">⏳</div>Loading staff...
        </div>
      ) : loadError ? (
        <div className="users-empty">
        ...
        <div className="users-empty">
          <div className="users-empty-icon">👤</div>No staff members found
        </div>
      ) : (
          ...
          {filtered.map((user) => (
            <div key={user.id} className="user-card">
              ...
              <div className="user-card-details">
                <span className={`user-detail-chip role-${user.role}`}>
                  {ROLE_ICONS[user.role]} {ROLE_DISPLAY[user.role] || user.role}
                </span>
                {user.department && (
                  <span className="user-detail-chip">{user.department}</span>
                )}
          ...
          >
            ...
            >
              ...
              <div className="delete-confirm-body">
                <p>
                  Remove <strong>{deleteCandidate.fullName}</strong> from Staff
                  Directory?
                </p>
