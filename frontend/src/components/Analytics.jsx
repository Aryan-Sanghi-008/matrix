...
const CSV_EXPORT_ROLES = ["ADMIN", "SUPERVISOR"];
    ...
    <div className="analytics-container">
      <div className="analytics-header">
        ...
        <div className="analytics-actions">
          {currentUser && CSV_EXPORT_ROLES.includes(currentUser.role) && (
            <button
              className="analytics-refresh"
              onClick={() => exportPatientsCsv().catch(console.error)}
            >
              📥 Export CSV
            </button>
          )}
          <button className="analytics-refresh" onClick={loadAnalytics}>
            ↻ Refresh
          </button>
        </div>
      </div>
                  ...
                  <div key={level} className="priority-bar-row">
                    ...
                    <div className="bar-track">
                      <div
                        ...
                        style={{
                          width: `${pct}%`,
                          background: priorityColors[level],
                        }}
                      />
                    </div>
