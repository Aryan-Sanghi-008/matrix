...
import {
  fetchRecycleBinPatients,
  restorePatientFromRecycleBin,
      ...
      <div className="recycle-bin-hero">
        <div>
          ...
          <p className="recycle-bin-subtitle">
            Deleted patients stay recoverable for 10 days before the backup is
            purged automatically.
          </p>
        </div>
        <div className="recycle-bin-hero-actions">
          <div className="recycle-bin-stat-card">
            <span className="recycle-bin-stat-value">
              {archivedPatients.length}
            </span>
            <span className="recycle-bin-stat-label">Archived Patients</span>
          </div>
          <button
            className="recycle-bin-refresh-btn"
            onClick={() => loadArchivedPatients({ silent: true })}
          >
            ...
            return (
              <article key={entry.id} className="recycle-bin-card">
                <div className="recycle-bin-card-top">
                  <div>
                    <div className="recycle-bin-patient-name">
                  ...
                  <span className="recycle-bin-retention-pill">
                    {formatRetention(entry.purgeAt)}
                  </span>
                </div>
                ...
                <div className="recycle-bin-card-body">
                  <div className="recycle-bin-detail-grid">
                    ...
                    <div className="recycle-bin-detail-block">
                      <span className="recycle-bin-detail-label">
                        Deleted By
                      </span>
