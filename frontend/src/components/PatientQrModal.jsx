      ...
      <div className="qr-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="qr-modal-header">
          ...
          <p className="qr-modal-subtitle">
            Scan to access full medical history
          </p>
        </div>

        <div className="qr-modal-patient-info">
          <div className="qr-patient-name">
          ...
          <div className="qr-patient-meta">
            ...
            <span
              ...
              style={{
                background: priorityColors[patient.priority] || "#64748b",
              }}
            >
              {patient.priority}
            </span>
        ...
        {!loading && !error && (
          <div className="qr-modal-actions">
            <button
              className="qr-action-btn qr-download"
            ...
            <button
              className={`qr-action-btn qr-copy ${copied ? "copied" : ""}`}
              onClick={handleCopy}
            >
              <span>{copied ? "✅" : "📋"}</span>{" "}
