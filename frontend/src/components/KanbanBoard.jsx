...
export default function KanbanBoard({ newPatient, onPatientsChange, highlightPatientId, onHighlighted, currentUser, onPatientArchived, canDragDrop = true, canRetriage = true, canArchive = true }) {
