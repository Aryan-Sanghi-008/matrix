...
public class Patient {
    ...
    public static class PatientBuilder {
        ...
        public PatientBuilder assignedDoctorUsername(String assignedDoctorUsername) {
            this.assignedDoctorUsername = assignedDoctorUsername;
            return this;
        }
        ...
        public PatientBuilder assignedNurseUsername(String assignedNurseUsername) {
            this.assignedNurseUsername = assignedNurseUsername;
            return this;
        }
        ...
        public Patient build() {
            return new Patient(id, name, age, symptoms, vitals, priority, rawInput, assignedCareZone, assignedRoom,
                    assignedDoctorName, assignedDoctorUsername, assignedDoctorSpecialization,
                    assignedNurseName, assignedNurseUsername, assignedSupportStaff,
